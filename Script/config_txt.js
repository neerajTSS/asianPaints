...
function validateElementsWithExcel(segment) {
    ...
    var segmentElement = Aliases.browser.pageLogon.FindElement("//ul[@id='dropdownlistbox8d1033a88ed231847248f1761eeea1c7_183-popup-list-listUl']/li/div/div/div[contains(text(),'" + segment + "')]");
    ...
    var subsegmentDropdownElements = Aliases.browser.pageLogon.FindElements("//*[@id='dropdownlistboxca597c13fe7214b57208b2ec262c7e0e_187-popup-list-listUl']/li/div/div/div");
